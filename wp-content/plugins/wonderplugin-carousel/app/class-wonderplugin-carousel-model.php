	...
	function generate_body_code($id, $has_wrapper) {
		...
		if ($item_row != null)
		{
			...
			jQuery(document).ready(function($){
				$(".amazingcarousel-item-container").each(function(i, elem){
					var img_color = $(this).find("img").attr("src");
					var img_bw = img_color.replace( ".png", "__bw.png" );
					$(this).find("img").attr("src", img_bw);
					$(this).hover(
						function() {
							$(this).find("img").attr("src", img_color);
							$(this).find(".amazingcarousel-title").show();
						}, 
						function() {
							$(this).find("img").attr("src", img_bw);
							$(this).find(".amazingcarousel-title").hide();
						}
					);
