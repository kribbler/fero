...
class WonderPlugin_Carousel_View {
	...
	function print_overview() {
		...
		<h2><?php echo __( 'WonderPlugin Carousel', 'wonderplugin_carousel' ) . ( (WONDERPLUGIN_CAROUSEL_VERSION_TYPE == "C") ? " Commercial Version" : " Free Version (tweaked by StudioEleven)") . " " . WONDERPLUGIN_CAROUSEL_VERSION; ?> </h2>
