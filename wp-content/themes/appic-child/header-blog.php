...
<style>
#inner_header {
    background: url("http://www.s11fero.co.nz/wp-content/uploads/2014/09/bg_inner_header_infonews.jpg") no-repeat scroll center top / 100% auto rgba(0, 0, 0, 0);
    height: 240px;
}
</style>
...
<section class="action-area-mini">
	...
	<?php if (!is_front_page()){?>
		...
		<div class="foto-pattern" id="inner_header">
						...
						<ul class="clear-list ch-second-grid">
							...
							<li>
								...
								<div class="ch-second-item">
									...
									<a class="ch-second-info" href="<?php echo get_theme_option('header_contact_link');?>">
